...
ENTITIES = {
    ...
    "Users": {
        ...
        # UserCreate doesn't accept "status" (new users are active by
        # default); it's only settable via UserUpdate.
        "create_exclude_fields": ["status"],
    },
    ...
    "Client Usage Statistics": {
        ...
        # ClientUsageStatisticsUpdate intentionally excludes client_id and
        # usage_date -- a stat row can't be reassigned to a different
        # client/date, only its counters can be updated.
        "update_exclude_fields": ["client_id", "usage_date"],
    },
    ...
    "Rule Versions": {
        ...
        # RuleVersionUpdate excludes rule_id (immutable once created).
        # ("active" is already added to the update form below via
        # _ACTIVE_ON_UPDATE.)
        "update_exclude_fields": ["rule_id"],
    },
